...
import com.example.birdnest.net.HttpClientManager;
import com.example.birdnest.updateManager.UpdateVersionImpl.UpdateVersion;
...
public class UpdateManager {
	...
	public static final String PATH = Environment.getExternalStorageDirectory()
			.getPath() + "/birdnest";
	public static final String APPNAME = "/birdnest.apk";
	...
	private void downloadVersionProcess(AppVersionLatest appVersionLatest) {
		FileHandler.createFile(UpdateManager.PATH);
		updateDialog();
 ...
 class UpdateCheckThread implements Runnable {
	...
	class NewVersion implements UpdateVersion {
		...
		public void onUpdateSuccess() {
			mPDialog.dismiss();
			Utility.installApk(mContext, UpdateManager.PATH + appname);
		}
